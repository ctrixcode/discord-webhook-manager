...
import { Home, Webhook, Clock, FileText, Settings, X, Users, Send } from "lucide-react"
import Link from "next/link"
import { usePathname } from "next/navigation"

const navigation = [
  { name: "Home", href: "/dashboard", icon: Home, color: "bg-blue-500 hover:bg-blue-600" },
  { name: "Webhooks", href: "/dashboard/webhooks", icon: Webhook, color: "bg-green-500 hover:bg-green-600" },
  { name: "Send Message", href: "/dashboard/send", icon: Send, color: "bg-cyan-500 hover:bg-cyan-600" },
  { name: "Scheduled", href: "/dashboard/scheduled", icon: Clock, color: "bg-orange-500 hover:bg-orange-600" },
  { name: "Templates", href: "/dashboard/templates", icon: FileText, color: "bg-purple-500 hover:bg-purple-600" },
  { name: "Avatars", href: "/dashboard/avatars", icon: Users, color: "bg-pink-500 hover:bg-pink-600" },
  { name: "Settings", href: "/dashboard/settings", icon: Settings, color: "bg-gray-500 hover:bg-gray-600" },
]
    ...
    <>
      ...
      <div
        className={cn(
          ...
          isOpen ? "top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" : "bottom-6 right-6",
        )}
      >

...
export const addWebhook = (webhook: Omit<Webhook, "id" | "createdAt" | "messageCount">): Webhook => {
...
export const sendTestMessage = async (webhookUrl: string, message: string): Promise<boolean> => {
  try {
